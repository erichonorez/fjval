...
public class CoreUnitTest {
    ...
    class Valid {
        ...
        @Test
        @DisplayName("Returns an empty list for a given value")
        void t0() {
        ...
        @Test
        @DisplayName("Returns an empty list even when the given value is null")
        void t1() {
    ...
    class Invalid {
        ...
        @Test
        @DisplayName("Returns a list with the given error")
        void t0() {
        ...
        @Test
        @DisplayName("Returns a list with an null value if the error is null")
        void t1() {
        ...
        class WithErrorHierarchy {
            ...
            @Test
            @DisplayName("Returns a list with a child class error")
            void t0() {
    ...
    class IsValid {
        ...
        @Test
        @DisplayName("Returns true if the given list is empty")
        void t0() {
            assertThat(isValid(valid("A valid value"))).isTrue();
        }

        @Test
        @DisplayName("Returns false if the given value is null")
        void t1() {
            assertThat(isValid(null)).isFalse();
        }

        @Test
        @DisplayName("Returns false if the given list is not empty")
        void t2() {
    ...
    class IsInvalid {
        ...
        @Test
        @DisplayName("Returns true if the given list is not empty")
        void t0() {
            assertThat(isInvalid(invalid("This is an error"))).isTrue();
        }

        @Test
        @DisplayName("Returns false if the given list is null")
        void t1() {
            assertThat(isInvalid(null)).isFalse();
        }

        @Test
        @DisplayName("Returns false if the given list is empty")
        void t2() {
    ...
    class Sequentially {
        ...
        @TestFactory
        @DisplayName("Returns an empty list if all validators succeeded")
        List<DynamicTest> t0() {
        ...
        @TestFactory
        @DisplayName("Returns an the error of the first failed validator")
        List<DynamicTest> t1() {
    ...
    class Every {
        ...
        @Test
        @DisplayName("Returns an empty list of all validators succeeded")
        void t0() {
            assertThat(isValid(gt0And5.apply(6))).isTrue();
        }

        @Test
        @DisplayName("Returns collected errors of the failed validators")
        void t1() {
        ...
        @Test
        @DisplayName("Executes all validators")
        void t2() {
    ...
    class Required {
        ...
        @Test
        @DisplayName("Returns the errors of the given validator if the value is not null but is not valid")
        void t1() {
        ...
        @Test
        @DisplayName("Returns the error provided by the given supplier if the validated value is null")
        void t2() {
    ...
    class CoreList {
        ...
        @Test
        @DisplayName("Returns the flattened collected errors")
        void t1() {
    ...
    class Not {
        ...
        @Test
        @DisplayName("Returns non-empty list containing the error provided by the supplier")
        void t1() {
